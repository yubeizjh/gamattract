...
<!-- Page content -->
<div class="w3-content" style="width:60%;margin-top:60px">
    <!-- Blog entry -->
    <div class="w3-round w3-card-4 w3-margin w3-white">
      <img class="w3-round" src="./gameImages/elden-ring.jpeg" alt="Norway" style="width:100%">
      <div class="w3-container">
      <h3><b>Elden Ring</b></h3>
      <h5>Put a ring on it. <span class="w3-opacity">Feb 23, 2022</span></h5>
      </div>
    ...
    <div class="w3-card-4 w3-margin w3-white w3-round">
        <img class="w3-round" src="./gameImages/genshin_impact.jpeg" alt="Nature" style="width:100%">
        <div class="w3-container">
        <h3><b>Genshin Impact</b></h3>
        <h5>Title description, <span class="w3-opacity">April 7, 2014</span></h5>
        </div>

        <div class="w3-container">
        <p>It's a great game which I like. We will do it later.</p>
        <div class="w3-row">
            <div class="w3-col m8 s12">
            <p><button class="w3-button w3-padding-large w3-white w3-border"><b>Not ready :)</b></button></p>
            </div>
            <div class="w3-col m4 w3-hide-small">
